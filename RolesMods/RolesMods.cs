...
namespace RolesMods {
    ...
    public class RolesMods : BasePlugin {
        ...
        public static CustomNumberOption footPrintSize = CustomOption.AddNumber("Footprint Size", 5, 1, 10, 1f);
        public static CustomNumberOption fontPrintInterval = CustomOption.AddNumber("Footprint Interval", 1f, 1f, 20f, 1f);
